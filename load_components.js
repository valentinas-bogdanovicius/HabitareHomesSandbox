        ...
        if (element) {
          ...
          if (
            ...
            const cities = [
              ...
              {
                name: "Alconbury Weald, Crest Nicholson",
                coords: [52.3758, -0.2403],
              },
              { name: "Dysart Road, Grantham", coords: [52.91, -0.6734] },
              { name: "Campbell Wharf", coords: [52.0499, -0.7367] },
              {
                name: "Towergate, Crest Nicholson",
                coords: [52.0313, -0.6788],
              },
              { name: "Coombe Farm, Saltdean", coords: [50.8127, -0.0253] },
              {
                name: "Tattenhoe Park, Crest Nicholson",
                coords: [51.9936, -0.8046],
              },
              {
                name: "Old Malling Farm, Lewes",
                coords: [50.885099, 0.002584],
              },
              {
                name: "Stanhope Gardens, Aldershot",
                coords: [51.25757190399515, -0.7646997198857641],
              },
            ];
            cities.map((c) =>
              L.marker(c.coords).addTo(map).bindTooltip(`${c.name}`),
            );
          }
        }
      })
